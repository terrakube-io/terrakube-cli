...
func TestCmdProviderListE2E(t *testing.T) {
	...
	handler := http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if !strings.Contains(r.URL.Path, "organization/a1b2c3d4-e5f6-7890-abcd-ef1234567890/provider") {
	...
	out, err := executeCommand("provider", "list", "--organization-id", "a1b2c3d4-e5f6-7890-abcd-ef1234567890")
	if err != nil {
...
func TestCmdProviderGetE2E(t *testing.T) {
	...
	handler := http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if !strings.Contains(r.URL.Path, "organization/a1b2c3d4-e5f6-7890-abcd-ef1234567890/provider/prov-456") {
			t.Errorf("unexpected path: %s", r.URL.Path)
		}
	...
	out, err := executeCommand("provider", "get", "--organization-id", "a1b2c3d4-e5f6-7890-abcd-ef1234567890", "--id", "prov-456")
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestCmdProviderDeleteE2E(t *testing.T) {
	...
	out, err := executeCommand("provider", "delete", "--organization-id", "a1b2c3d4-e5f6-7890-abcd-ef1234567890", "--id", "prov-del")
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
